...
const PARAMS = {
  ...
  weightDisk: "Максимальный объем данных",
...
function insertWeightPapers() {
  ...
  let nameLabel = selectService === "Переплет" ? PARAMS.weightBinding :
                  ...
                  selectService === "Распечатка" && selectSize === "CD/DVD диск" ? PARAMS.weightDisk : PARAMS.weightPaper;
...
>>>>>>> 53402fe0cefda000b467883f913954bfbe129b31
     ...
     [PARAMS.pagePerSheet] : ((selectService !== "Переплет"
         ...
         && selectService !== "Ксерокс")
          && !(selectService === "Распечатка" && selectSize === "CD/DVD диск") ) ? selectPagePerSheet : ""
   };
